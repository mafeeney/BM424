...
dis_name2 <- "influenza"
outbreak_deaths <- 24 + 18 + 13
```

## Scenario B

`r dis_name2` outbreak in `r city_name`
...
Table 1. Data from the `r city_name` `r dis_name2` outbreak.
<table>
<table border="1">
  <tr>
    <th></th>
  ...
  <tr>
    <td>Deaths caused by the `r dis_name2` outbreak (weekly)</td>
    <td>24</td>
    <td>13</td>
  </tr>
  <tr>
    <td>Verified `r dis_name2` cases (total)</td>
    <td>330</td>
    <td>450</td>
  </tr>
  <tr>
    <td>`r dis_name2` hospitalisations (weekly)</td>
    <td>159</td>
    <td>112</td>
  </tr>
    <tr>
  ...
  <tr>
  <td>Number of `r dis_name2` related GP visits (weekly)</td>
  <td>91</td>
  <td>87</td>
  </tr>
</table>  
...
## News Coverage of the `r city_name` influenza outbreak
...
The `r dis_name2` pandemic ravaging `r city_name` has claimed yet another victim. There have been `r outbreak_deaths` deaths in the pandemic so far, but perhaps the most tragic loss is `r obit1name` `r obit1surname` - at only `r obit1age`, the youngest victim that the pandemic has claimed.    
...
There have been 13 deaths due to `r dis_name2` in `r city_name` this week. This is an enormous decrease, and hopefully `r city_name` will see the death toll continue to decrease in the coming weeks. 
...
There have been `r outbreak_deaths` deaths in the pandemic so far, but perhaps the most frightening aspect to this new pandemic is rumours that this variant of avian influenza has crossed the species barrier and can be transmitted from human to human.
...
Table 2. RT-PCR testing of animals in the `r city_name` `r dis_name2` outbreak.
<table>
<table border="1">
  <tr>
    <th>Location</th>
