...
```{r influenza, echo=FALSE, fig.cap="False-coloured transmission electron microscopy (TEM) image of an influenza virus particle. Image credit: [CDC](https://phil.cdc.gov/Details.aspx?pid=10073)"}
