...
REPLACE THIS TEXT and TABLE - A team of scientists working together have in a PHS lab have isolated and cultured <i>Campylobacter jejuni</i> virus (using a standard tissue culture model) from a number of patient samples taken during this outbreak; isolated <i>Campylobacter jejuni</i> RNA from these cultures; reverse-transcribed this to DNA and sequenced this DNA using an Illumina MiSeq platform; assembled the short paired-end reads; and compared these assemblies to the extant <i>Campylobacter jejuni</i> sequences available in the NCBI databases. The results of these experiments are summarised in the table below. 
...
You are familiar with the culture requirements for growth of <i>Campylobacter</i>, and the range of [UK Standards for Microbiology Investigations (UK SMI) for Identification of Campylobacter species](https://assets.publishing.service.gov.uk/government/uploads/system/uploads/attachment_data/file/685065/ID_23i3.1.pdf).
