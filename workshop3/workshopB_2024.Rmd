...
9.  Epidemiologist from the local university, an expert on influenza virus A transmission
...
=======
You should submit 3-5 specific actions to control the pandemic, using the [workshop 3 pro forma](/proformas/BM424_workshop3_proforma.docx) (also available on MyPlace). Submit this by noon, Friday March 1st, via the submission link on MyPlace. 
>>>>>>> a59875f3ebf67ebf397f9e4cede9dd2ddcad69c4
...
```{r A4, fig.cap="Public expenditures by category for the 2022-2023 financial year (Source: Baltyre City Council)", echo=FALSE}
...
You are an epidemiologist working for Public Health Scotland, sent to `r city_name` to help with the influenza outbreak.
...
## Information Packet B9

You are an epidemiologist working at the University of `r city_name`, and have been studying influenza A transmission dynamics for the past `r sample(2:10, size=1)` years. As such, you are very familiar with the relevant literature, including papers such as: 
