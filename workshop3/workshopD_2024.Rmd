...
```
<br><br>
The overall budget (expenditures) for the 2022-2023 financial year was £`r sample(400000000:600000000, size=1)`. A summary of expenditures by category for this financial year is shown below. 

```{r A4, fig.cap="Public expenditures by category for the 2022-2023 financial year (Source: Rosblane City Council)", echo=FALSE}
