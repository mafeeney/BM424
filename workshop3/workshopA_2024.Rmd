...
```{r A10, fig.cap="Inverkeld water usage for 2022-2023 (Source: SEPA)", echo=FALSE}
...
## Information Packet A9

You are an epidemiologist working at the University of `r city_name`, and have been studying <i>Legionella</i> transmission dynamics for the past `r sample(2:10, size=1)` years. As such, you are very familiar with the relevant literature, including papers such as: 
