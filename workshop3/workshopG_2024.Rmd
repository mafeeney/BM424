...
```{r A4, fig.cap="Public expenditures by category for the 2202-2023 financial year (Source: Glenleith City Council)", echo=FALSE}
...
```{r A5, fig.cap="Hospital expenditures by category for financial year 2202-2023 (Source: NHS Scotland)", echo=FALSE}
...
You are an epidemiologist working at the University of `r city_name`, and have been studying <i>Mycobacterium</i> transmission dynamics for the past `r sample(2:10, size=1)` years. As such, you are very familiar with the relevant literature, including papers such as: 
