...
dis_name4 <- "<i>Bacillus anthracis</i>"
outbreak_deaths <- 15

```

## Scenario I: Anthrax in `r city_name`
...
1. Contact & whereabouts tracing of current cases to find possible sources and commonalities over the past week; e.g. location, occupation, handling of infected animal products

2. Antibiotic prophylaxis and vaccination of exposed people/families and livestock based on tracing from above point.
Antibiotics dependent on type:
Inhalation/GI – combination of 2 ciprofloxacin & doxycycline, or amoxicillin & imipenem
Cutaneous: ciprofloxacin, doxycycline, or amoxicillin.
Vaccine: Anthrasil for both human and animal


3. Public awareness campaign - specifically target famers/butchers/slaughter houses etc. to educate people on the outbreak/risks. 

Ticktock, TV, radio, flyers, community meetings

4. Stop all export of animal products (meat, skin, fleece/wool) to prevent spread to other areas, until source has been identified.


## Pandemic Statistics 

Table 1. Data from the `r city_name` Anthrax outbreak.
<table>
<table border="1">
  <tr>
    <th></th>
  ...
  <tr>
    <td>Deaths caused by the Anthrax outbreak (total)</td>
    <td>10</td>
    <td>15</td>
  </tr>
  <tr>
    <td>Verified Anthrax cases (total)</td>
    <td>579</td>
    <td>679</td>
  </tr>
  <tr>
    <td>Anthrax hospitalisations (weekly)</td>
    <td>145</td>
    <td>112</td>
  </tr>
    <tr>
  ...
  <tr>
  <td>Number of Anthrax related GP visits (total)</td>
  <td>140</td>
  <td>112</td>
  </tr>
</table>  
...
I am so outraged by all of the restrictions that you are imposing on our wonderful city and our normally successful businesses. By stopping export of animal products, you are stifling our economy - how do you expect to maintain the health and well-being of our city if no one can afford to eat anymore, I ask you that! 

Many successful businesses are still struggling in the wake of COVID and due to the ongoing cost of living crisis, I would think that the government would be stepping in just now to help businesses and not actively working to hurt them. This is such a disgrace, you ought to be ashamed of yourselves and you ought to keep your interfering busybody noses out of everyone's businesses (literally). 
...
I heard that there was a vaccine that can help protect us, but I am not eligible for this, I was wondering what should I do? Can you please get extra vaccine supplies so that everyone can be eligible? It would be great if we were all protected by the vaccine.
...
## News Coverage of the `r city_name` Tuberculosis outbreak
...
Hard on the heels of the COVID-19 pandemic and a number of other health scares (monkeypox, or "mpox", avian flu, and worries about other infectious disease outbreaks), another pandemic has hit the Scottish town of `r city_name`. This time, it's Bacillus anthracis, a bacterium that you may remember from the bioterrorism scare several years ago. 

There have been `r outbreak_deaths` deaths in the pandemic so far, but perhaps the most frightening aspect to this new pandemic is rumours that these Bacillus anthracis strains may have become resistant to even more antibiotics - a truly chilling possibility.
...
Some of the Bacillus anthracis strains found in `r city_name` are reportedly resistant to all clinically available antibiotics, and scientists warn that these drug-resistant pathogens might be able to spread to new locations. Will nearby towns be next, or could these Bacillus anthracis strains go as global as the SARS-COV2 virus did?
...
Table 3. Contact tracing results results from patients with current anthrax cases (`r city_name`, 24/02/2024)
<table>
<table border="1">
  <tr>
    <th>Patient no.</th>
    <th>Movements 1 week prior to symptom onset</th>
  </tr>
  <tr>
    <td>1</td>
  ...
  <tr>
    <td>4</td>
    <td>`r sample(work1, 1)`,`r sample(shop1, sample(0:3, 1))`, `r sample(shop2, sample(0:3, 1))`, `r sample(restaurant1, sample(0:6, 1))`, `r sample(other1, sample(0:10, 1))`, `r sample(travel1, sample(0:2, 1))`, the Ardkeld Home Butchers'</td>
  </tr>
  <tr>
    <td>5</td>
    <td>`r sample(work1, 1)`, `r sample(shop1, sample(0:3, 1))`, `r sample(shop2, sample(0:3, 1))`, `r sample(restaurant1, sample(0:6, 1))`, `r sample(other1, sample(0:10, 1))`, `r sample(travel1, sample(0:2, 1))`</td>
  ...
  <tr>
    <td>6</td>
    <td>`r sample(work1, 1)`, `r sample(shop1, sample(0:3, 1))`, `r sample(shop2, sample(0:3, 1))`, `r sample(restaurant1, sample(0:6, 1))`, `r sample(other1, sample(0:10, 1))`, `r sample(travel1, sample(0:2, 1))`, Ardkeld petting zoo</td>
  </tr>
  <tr>
    <td>7</td>
  ...
  <tr>
    <td>8</td>
    <td>`r sample(work1, 1)`, `r sample(shop1, sample(0:3, 1))`, the farm, `r sample(shop2, sample(0:3, 1))`, `r sample(restaurant1, sample(0:6, 1))`, `r sample(other1, sample(0:10, 1))`, `r sample(travel1, sample(0:2, 1))`</td>
  </tr>
  <tr>
    <td>9</td>
    <td>`r sample(work1, 1)`, `r sample(shop1, sample(0:3, 1))`, `r sample(shop2, sample(0:3, 1))`, `r sample(restaurant1, sample(0:6, 1))`, `r sample(other1, sample(0:10, 1))`, `r sample(travel1, sample(0:2, 1))`</td>
  ...
  <tr>
    <td>11</td>
    <td>`r sample(work1, 1)`, `r sample(shop1, sample(0:3, 1))`, Ardkeld Home Farm Shop, `r sample(shop2, sample(0:3, 1))`, `r sample(restaurant1, sample(0:6, 1))`, `r sample(other1, sample(0:10, 1))`, `r sample(travel1, sample(0:2, 1))`</td>
  </tr>
  <tr>
    <td>12</td>
    <td>`r sample(shop1, sample(0:3, 1))`, `r sample(shop2, sample(0:3, 1))`, `r sample(restaurant1, sample(0:6, 1))`, `r sample(other1, sample(0:10, 1))`, `r sample(travel1, sample(0:2, 1))`</td>
  ...
  <tr>
    <td>20</td>
    <td>`r sample(work1, 1)`, `r sample(shop1, sample(0:3, 1))`, `r sample(shop2, sample(0:3, 1))`, `r sample(restaurant1, sample(0:6, 1))`, `r sample(other1, sample(0:10, 1))`, the Ardkeld Home Butchers' `r sample(travel1, sample(0:2, 1))`</td>
  </tr>
  <tr>
    <td>21</td>
    <td>`r sample(work1, 1)`, `r sample(shop1, sample(0:3, 1))`, `r sample(shop2, sample(0:3, 1))`, `r sample(restaurant1, sample(0:6, 1))`, `r sample(other1, sample(0:10, 1))`, `r sample(travel1, sample(0:2, 1))`</td>
  ...
  <tr>
    <td>26</td>
    <td>`r sample(work1, 1)`, the Ardkeld Home Butchers', `r sample(shop1, sample(0:3, 1))`, `r sample(shop2, sample(0:3, 1))`, `r sample(restaurant1, sample(0:6, 1))`, `r sample(other1, sample(0:10, 1))`, `r sample(travel1, sample(0:2, 1))`</td>
  </tr>
  <tr>
    <td>27</td>
  ...
  <tr>
    <td>29</td>
    <td>`r sample(work1, 1)`, `r sample(shop1, sample(0:3, 1))`, `r sample(shop2, sample(0:3, 1))`, `r sample(restaurant1, sample(0:6, 1))`, `r sample(other1, sample(0:10, 1))`, `r sample(travel1, sample(0:2, 1))`, the butcher's, the cheese shop in town, Skye Candles</td>
  </tr>
  <tr>
    <td>30</td>
    <td>`r sample(work1, 1)`, `r sample(shop1, sample(0:3, 1))`, `r sample(shop2, sample(0:3, 1))`, `r sample(restaurant1, sample(0:6, 1))`, `r sample(other1, sample(0:10, 1))`, `r sample(travel1, sample(0:2, 1))`</td>
  ...
  <tr>
    <td>31</td>
    <td>`r sample(work1, 1)`, `r sample(shop1, sample(0:3, 1))`, `r sample(shop2, sample(0:3, 1))`, `r sample(restaurant1, sample(0:6, 1))`, `r sample(other1, sample(0:10, 1))`, the greengrocers</td>
  </tr>
  <tr>
    <td>32</td>
    <td>`r sample(work1, 1)`, `r sample(shop1, sample(0:3, 1))`, `r sample(shop2, sample(0:3, 1))`, `r sample(restaurant1, sample(0:6, 1))`, `r sample(other1, sample(0:10, 1))`, the Ardkeld Home Butchers</td>
  </tr>
  <tr>
    <td>33</td>
    <td>`r sample(no, 1)`</td>
  ...
  <tr>
    <td>34</td>
    <td> `r sample(work1, 1)`, the zoo, `r sample(shop1, sample(0:3, 1))`, `r sample(shop2, sample(0:3, 1))`, `r sample(restaurant1, sample(0:6, 1))`, `r sample(other1, sample(0:10, 1))`, `r sample(travel1, sample(0:2, 1))`</td>
  </tr>
  <tr>
    <td>35</td>
    <td> `r sample(work1, 1)`, `r sample(shop1, sample(0:3, 1))`, `r sample(shop2, sample(0:3, 1))`, `r sample(restaurant1, sample(0:6, 1))`, `r sample(other1, sample(0:10, 1))`, `r sample(travel1, sample(0:2, 1))`, done lots of shopping</td>
  </tr>
  <tr>
    <td>36</td>
    <td> `r sample(work1, 1)`, `r sample(shop1, sample(0:3, 1))`, `r sample(shop2, sample(0:3, 1))`, `r sample(restaurant1, sample(0:6, 1))`, `r sample(other1, sample(0:10, 1))`, the butchers, the florist</td>
  </tr>
  <tr>
    <td>37</td>
    <td> `r sample(work1, 1)`, `r sample(shop1, sample(0:3, 1))`, `r sample(shop2, sample(0:3, 1))`, `r sample(restaurant1, sample(0:6, 1))`, `r sample(other1, sample(0:10, 1))`, `r sample(travel1, sample(0:2, 1))`</td>
