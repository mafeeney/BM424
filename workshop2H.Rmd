...
outbreak_deaths <- 23 + 12 + 9

##outcomes based on their actions: decrease in cases, hospitalizations, deaths. E-mail complaints/bad press over mask wearing, effects on children's education, etc. 

##Results from increased testing 
##antibiotic shortage
```

## Scenario H

`r dis_name8` in `r city_name`
...
Table 1. Data from the `r city_name` `r dis_name8` outbreak.
<table>
<table border="1">
  <tr>
    <th></th>
  ...
  <tr>
    <td>Deaths caused by the `r dis_name8` outbreak (weekly)</td>
    <td>23</td>
    <td>9</td>
  </tr>
  <tr>
    <td>Verified `r dis_name8` cases (total)</td>
    <td>350</td>
    <td>550</td>
  </tr>
  <tr>
    <td>`r dis_name8` hospitalisations (weekly)</td>
    <td>154</td>
    <td>47</td>
  </tr>
    <tr>
  ...
  <tr>
  <td>Number of `r dis_name8` related GP visits (weekly)</td>
  <td>87</td>
  <td>49</td>
  </tr>
</table>  
...
## Increased testing for <i>S. pyogenes</i>

Throat swabs were processed according to standard protocols and isolates characterised on appropriate chromogenic agar media. A representative sample of tests are shown.

Table 2. Identification of <i>S. pyogenes</i> from patient samples taken during the  `r city_name` outbreak. 
<table>
<table border="1">
  <tr>
    <th>Test sample #</th>
    <th><i>S. pyogenes</i> +ve culture</th>
  </tr>
  <tr>
    <td>1</td>
    <td>-</td>
