...
You are the director of `r city_name`'s main hospital, the `r hospital_name`, which has 500 beds across 8 different wards and 10 operating theatres. The annual operating budget for financial year 2021-2022 was £1.3 million, and average expenditures are shown by category in the figure below. 
...
```{r Legionella, echo=FALSE, fig.cap="Legionella grown on BCYE agar. Image credit: [CDC](https://www.cdc.gov/legionella/resources/materials.html)"}
